...
All security vulnerability reports MUST be submitted by email to: [secalert@redhat.com](mailto:secalert@redhat.com)

Security vulnerabilities MUST NOT be reported through public channels such as GitHub issues, pull requests, discussion forums, or social media.
...
* The Security Team aims to confirm receipt of vulnerability reports within one (1) business day.
* Our goal is to assess the report, coordinate a fix and disclosure as quickly as possible.
...
For the complete security policy, including what qualifies as a reportable vulnerability, severity classification, the response process, coordinated disclosure, and the vulnerability management process, see [Red Hat Product Security](https://www.redhat.com/en/solutions/security-approach).
