...
All community events and participants therein are governed by this Code of Conduct and
...
participation in all project-related forums and mailing lists, code and documentation
contributions, public chat, private correspondence, and public meetings.
...
the work of others, decisions you make surrounding your contributions to the
...
Everyone should feel welcome in the community, regardless of their background.
...
The community is committed to being a welcoming environment for all users,
...
- emailing [codeofconduct@syntara-orchestration.org](mailto:codeofconduct@syntara-orchestration.org)
- contacting anyone with administrative power in community chat
- contacting the local organizers of an event

Meetup organizers are encouraged to prominently display points of contact for reporting
...
Attribution-Share Alike 3.0 license. It was adapted from Codes of Conduct
...
See [AI_POLICY.md](AI_POLICY.md) for the community policy on AI-assisted contributions.
