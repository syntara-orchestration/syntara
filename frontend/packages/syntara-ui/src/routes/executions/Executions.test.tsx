...
describe('Executions Component', () => {
  const mockExecutions: ExecutionsAPI.components['schemas']['ExecutionRead'][] = [
    ...
    },
    {
      ...
      status: 'running',
      created_by: { id: 'b2c3d4e5-f6a7-8901-bcde-f12345678901', name: 'user-2' },
      updated_by: null,
      completed_at: null,
    ...
    },
    {
      ...
      status: 'failed',
      created_by: { id: 'c3d4e5f6-a7b8-9012-cdef-123456789012', name: 'user-3' },
      updated_by: { id: 'c3d4e5f6-a7b8-9012-cdef-123456789012', name: 'user-3' },
