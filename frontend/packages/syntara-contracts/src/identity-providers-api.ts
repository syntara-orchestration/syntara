  ...
  list_identity_providers: {
    parameters: {
      query?: {
        ...
        /**
         * @description Filter identity providers by enabled state.
        ...
        /**
         * @description Filter identity providers by provider type.
         *     - Exact match: `provider_type=oidc` or `provider_type[eq]=oidc`
         */
        provider_type?: string & {
          /**
           * Equals
           * @description Exact match of the provider type. ?provider_type[eq]=oidc
           */
          eq?: string
          /**
           * Contains
           * @description Substring match (case-insensitive). ?provider_type[contains]=<substring>
           */
          contains?: string
          /**
           * Starts With
           * @description Prefix match (case-insensitive). ?provider_type[starts_with]=<prefix>
           */
          starts_with?: string
          /**
           * Greater Than
           * @description Greater than comparison (lexicographical). ?provider_type[gt]=<value>
           */
          gt?: string
          /**
           * Greater Than Or Equal
           * @description Greater than or equal comparison. ?provider_type[gte]=<value>
           */
          gte?: string
          /**
           * Less Than
           * @description Less than comparison (lexicographical). ?provider_type[lt]=<value>
           */
          lt?: string
          /**
           * Less Than Or Equal
           * @description Less than or equal comparison. ?provider_type[lte]=<value>
           */
          lte?: string
        }
      }
