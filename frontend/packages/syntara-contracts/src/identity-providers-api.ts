...
export interface components {
  schemas: {
    /**
     * OIDCClaimMapping
     * @description Maps Automation Orchestrator user fields to IdP-specific OIDC claim names.
     */
    OIDCClaimMapping: {
      /**
       * Subject
     ...
     * @description API-facing schema for a single IdP-to-Automation Orchestrator group mapping entry.
     *
