...
export interface paths {
  ...
  '/_internal/metrics/kpis': {
    ...
    /**
     * Metrics store KPIs
     * @description Return a computed KPI dashboard covering all Automation Orchestrator components.
     *
...
export interface components {
  schemas: {
    /**
     * ComponentKPISummary
     * @description KPI summary for a single Automation Orchestrator component.
     */
    ComponentKPISummary: {
      /**
       * Component
    ...
    /**
     * KPIDashboard
     * @description Full KPI dashboard covering all Automation Orchestrator components.
     */
    KPIDashboard: {
      /**
       * Generated At
    ...
    /**
     * MetricType
     * @description Categories of metrics recorded by Automation Orchestrator.
     *
