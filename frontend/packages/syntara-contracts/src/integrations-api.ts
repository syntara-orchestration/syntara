...
export interface components {
  schemas: {
     ...
     * @enum {string}
     */
    IntegrationType: 'mcp_server' | 'llm_provider' | 'ansible_automation_platform' | 'terraform_enterprise'
    /**
     * IntegrationStatus
    ...
    IntegrationCreate: {
      ...
      configuration:
        ...
        | components['schemas']['TFEConfiguration']
      /**
    ...
    /**
     * TFEConfiguration
     * @description Configuration for Terraform Enterprise / HCP Terraform integrations.
     */
    TFEConfiguration: {
      /**
       * @description discriminator enum property added by openapi-typescript
