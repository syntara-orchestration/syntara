...
export interface components {
  schemas: {
     ...
     * @description Non-secret OpenShift connection and its registered execution target.
     */
    OpenShiftConfiguration: {
      /**
       * @description discriminator enum property added by openapi-typescript
      ...
      /**
       * Base Url
       * @description OpenShift Kubernetes API URL, including port
       */
      base_url: string
      /**
       * Namespace
       * @description Namespace for ephemeral executor pods
       */
      namespace: string
      /**
       * Execution Target Id
       * Format: uuid
       * @description Execution Plane target linked to this cluster
       */
