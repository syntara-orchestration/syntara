...
| **Accessibility audit**         | `a11y-audit/SKILL.md`                  | Registry axe sweep (`npm run e2e:a11y-audit`) plus manual keyboard/media/semantic checks and bug filing                                                             | Say "run an a11y audit" or type `/a11y-audit` before filing accessibility bugs.                                                              |
...
| `/a11y-audit`                | Registry axe sweep plus manual keyboard, viewport/media, and semantic WCAG checks        |
