...
| **Accessibility audit**         | `a11y-audit.md`                        | Beyond axe-core: keyboard traversal, viewport/media matrix, landmarks/headings, Jira bug filing with impact → priority mapping                                      | Say "run an a11y audit" or type `/a11y-audit` before filing accessibility bugs.                                                              |
