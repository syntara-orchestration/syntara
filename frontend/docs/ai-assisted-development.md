...
| **Accessibility audit**         | `a11y-audit.md`                        | Registry axe sweep (`npm run e2e:a11y-audit`) plus manual keyboard/media/semantic checks and Jira filing | Say "run an a11y audit" or type `/a11y-audit` before filing accessibility bugs.                                                              |
