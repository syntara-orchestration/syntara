...
| **Command palette (Ctrl/Cmd+K)**    | [`docs/architecture.md`](docs/architecture.md) -- "Add a command-palette search source"; `packages/syntara-ui/src/components/command-palette/`                                                                                                                                                             |
