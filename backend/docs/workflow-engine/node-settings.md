...
- [V2 Schema](https://github.com/syntara-orchestration/syntara/blob/devel/backend/src/syntara/schemas/workflows/v2/workflow_definition.schema.json) — JSON schema source of truth
