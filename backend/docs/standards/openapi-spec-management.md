...
- `openapi-public.yaml` is generated by `make api-spec-public-bundle`; it excludes internal domains (see below)
...
| `make api-spec-public-bundle` | Merge public domain sub-specs into `src/syntara/schemas/openapi-public.yaml` |
| `make api-spec-bundle-all` | Run both `api-spec-bundle` and `api-spec-public-bundle` |
| `make api-spec-drift` | Check that the committed spec matches the generated one (exit 1 if out of sync) |
| `make api-spec-public-drift` | Same, for the public spec |
| `make api-spec-drift-all` | Run both `api-spec-drift` and `api-spec-public-drift` |
...
Use `make api-spec-public-bundle` to regenerate, or `make api-spec-bundle-all` to regenerate both specs together. CI runs `api-spec-bundle-all` and `api-spec-drift-all` to check both.
