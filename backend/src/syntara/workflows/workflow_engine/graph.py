...
_NODE_SETTINGS_CLASS: dict[str, type[NodeSettingsBase]] = {
    ...
    NodeType.TFE_CREATE_WORKSPACE: NodeSettingsNoRetry,
    NodeType.TFE_LIST_WORKSPACES: NodeSettingsFull,
    NodeType.TFE_UPDATE_WORKSPACE: NodeSettingsNoRetry,
    NodeType.TFE_DELETE_WORKSPACE: NodeSettingsNoRetry,
    NodeType.TFE_FETCH_STATE_OUTPUTS: NodeSettingsFull,
    NodeType.TFE_ADD_VARIABLE: NodeSettingsNoRetry,
    NodeType.TFE_LIST_VARIABLES: NodeSettingsFull,
    NodeType.TFE_UPDATE_VARIABLE: NodeSettingsNoRetry,
    NodeType.TFE_DELETE_VARIABLE: NodeSettingsNoRetry,
    NodeType.TFE_UPLOAD_CONFIGURATION_VERSION: NodeSettingsNoRetry,
    NodeType.TFE_TRIGGER_RUN: NodeSettingsNoRetry,
    NodeType.TFE_GET_RUN_STATUS: NodeSettingsFull,
    NodeType.TFE_APPLY_RUN: NodeSettingsNoRetry,
    NodeType.TFE_DISCARD_RUN: NodeSettingsNoRetry,
    NodeType.TFE_CANCEL_RUN: NodeSettingsNoRetry,
    NodeType.TFE_FORCE_CANCEL_RUN: NodeSettingsNoRetry,
    NodeType.TFE_LIST_RUNS: NodeSettingsFull,
    NodeType.TFE_ADD_RUN_COMMENT: NodeSettingsNoRetry,
    NodeType.TFE_LIST_GITHUB_INSTALLATIONS: NodeSettingsFull,
    NodeType.TFE_GET_GITHUB_INSTALLATION: NodeSettingsFull,
    NodeType.TFE_LINK_VCS: NodeSettingsNoRetry,
    NodeType.TFE_CREATE_PROJECT: NodeSettingsNoRetry,
    NodeType.TFE_LIST_PROJECTS: NodeSettingsFull,
    NodeType.TFE_GET_PROJECT: NodeSettingsFull,
    NodeType.TFE_UPDATE_PROJECT: NodeSettingsNoRetry,
    NodeType.TFE_DELETE_PROJECT: NodeSettingsNoRetry,
    NodeType.TFE_MOVE_WORKSPACE_TO_PROJECT: NodeSettingsNoRetry,
    NodeType.TFE_ASSIGN_TEAM_PERMISSIONS: NodeSettingsNoRetry,
}
