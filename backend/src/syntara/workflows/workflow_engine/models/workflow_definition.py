...
class AAPResourceReferenceMixin(BaseModel):
    ...
    credential_id: str | None = Field(
        default=None,
        description=(
            "Automation Orchestrator credential UUID for Ansible Automation Platform API authentication. "
...
class ApprovalNodeParameters(BaseModel):
    ...
    credential_id: str | None = Field(default=None, description="Automation Orchestrator credential UUID")
