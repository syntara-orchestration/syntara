...
BUILTIN_POLICIES: list[PolicyInfo] = [
    ...
    PolicyInfo("form_prompt", "submit", roles=("admin",)),
    # projects
    ...
    PolicyInfo("form_prompt", "submit", scope="project", roles=("project-admin", "project-user")),
    ...
    PolicyInfo("files", "delete", roles=("admin", "user")),
    ...
    PolicyInfo("files", "delete", scope="project", roles=("project-admin", "project-user")),
    # -- service accounts --
