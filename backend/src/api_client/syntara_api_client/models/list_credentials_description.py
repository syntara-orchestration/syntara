...
T = TypeVar("T", bound="ListCredentialsDescription")


@_attrs_define
class ListCredentialsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_credentials_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_credentials_description.additional_properties = d
        return list_credentials_description
