...
T = TypeVar("T", bound="ListExecutionActivitiesCreatedAt")


@_attrs_define
class ListExecutionActivitiesCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_execution_activities_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_execution_activities_created_at.additional_properties = d
        return list_execution_activities_created_at
