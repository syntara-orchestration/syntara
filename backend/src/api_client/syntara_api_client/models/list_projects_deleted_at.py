...
T = TypeVar("T", bound="ListProjectsDeletedAt")


@_attrs_define
class ListProjectsDeletedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_projects_deleted_at.additional_properties = d
        return list_projects_deleted_at
