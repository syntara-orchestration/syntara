...
T = TypeVar("T", bound="ListSettingsDescription")


@_attrs_define
class ListSettingsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_settings_description.additional_properties = d
        return list_settings_description
