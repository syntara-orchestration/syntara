...
T = TypeVar("T", bound="ListGroupsUpdatedAt")


@_attrs_define
class ListGroupsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_updated_at.additional_properties = d
        return list_groups_updated_at
