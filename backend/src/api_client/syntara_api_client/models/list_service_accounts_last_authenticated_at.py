...
T = TypeVar("T", bound="ListServiceAccountsLastAuthenticatedAt")


@_attrs_define
class ListServiceAccountsLastAuthenticatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_service_accounts_last_authenticated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_service_accounts_last_authenticated_at.additional_properties = d
        return list_service_accounts_last_authenticated_at
