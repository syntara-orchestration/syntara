...
T = TypeVar("T", bound="ListProjectRolesDescription")


@_attrs_define
class ListProjectRolesDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_roles_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_project_roles_description.additional_properties = d
        return list_project_roles_description
