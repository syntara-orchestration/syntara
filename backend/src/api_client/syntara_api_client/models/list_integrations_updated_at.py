...
T = TypeVar("T", bound="ListIntegrationsUpdatedAt")


@_attrs_define
class ListIntegrationsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integrations_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_integrations_updated_at.additional_properties = d
        return list_integrations_updated_at
