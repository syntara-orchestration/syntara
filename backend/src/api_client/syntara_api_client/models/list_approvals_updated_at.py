...
T = TypeVar("T", bound="ListApprovalsUpdatedAt")


@_attrs_define
class ListApprovalsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_approvals_updated_at.additional_properties = d
        return list_approvals_updated_at
