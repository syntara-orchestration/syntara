...
T = TypeVar("T", bound="ListIdentityProvidersCreatedAt")
...
class ListIdentityProvidersCreatedAt:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_identity_providers_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_identity_providers_created_at.additional_properties = d
        return list_identity_providers_created_at
