...
T = TypeVar("T", bound="ListUsersDirectoryLastName")


@_attrs_define
class ListUsersDirectoryLastName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_directory_last_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_users_directory_last_name.additional_properties = d
        return list_users_directory_last_name
