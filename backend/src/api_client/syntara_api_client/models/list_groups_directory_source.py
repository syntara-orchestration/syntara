...
T = TypeVar("T", bound="ListGroupsDirectorySource")


@_attrs_define
class ListGroupsDirectorySource:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_directory_source = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_groups_directory_source.additional_properties = d
        return list_groups_directory_source
