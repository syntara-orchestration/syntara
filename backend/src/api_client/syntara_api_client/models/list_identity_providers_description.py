...
T = TypeVar("T", bound="ListIdentityProvidersDescription")


@_attrs_define
class ListIdentityProvidersDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_identity_providers_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_identity_providers_description.additional_properties = d
        return list_identity_providers_description
