...
T = TypeVar("T", bound="ListWorkflowsCreatedAt")


@_attrs_define
class ListWorkflowsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_workflows_created_at.additional_properties = d
        return list_workflows_created_at
