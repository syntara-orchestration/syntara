...
T = TypeVar("T", bound="ListProjectRolesCreatedAt")


@_attrs_define
class ListProjectRolesCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_roles_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_project_roles_created_at.additional_properties = d
        return list_project_roles_created_at
