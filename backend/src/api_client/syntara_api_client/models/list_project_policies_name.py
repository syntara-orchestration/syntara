...
T = TypeVar("T", bound="ListProjectPoliciesName")


@_attrs_define
class ListProjectPoliciesName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_policies_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_project_policies_name.additional_properties = d
        return list_project_policies_name
