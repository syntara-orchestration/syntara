...
T = TypeVar("T", bound="ListToolsCreatedAt")


@_attrs_define
class ListToolsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_tools_created_at.additional_properties = d
        return list_tools_created_at
