...
T = TypeVar("T", bound="ListServiceAccountsName")


@_attrs_define
class ListServiceAccountsName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_service_accounts_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_service_accounts_name.additional_properties = d
        return list_service_accounts_name
