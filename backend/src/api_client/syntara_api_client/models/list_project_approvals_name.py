...
T = TypeVar("T", bound="ListProjectApprovalsName")


@_attrs_define
class ListProjectApprovalsName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_approvals_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_project_approvals_name.additional_properties = d
        return list_project_approvals_name
