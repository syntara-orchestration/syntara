...
T = TypeVar("T", bound="ListExecutionsDeletedAt")


@_attrs_define
class ListExecutionsDeletedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_executions_deleted_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_executions_deleted_at.additional_properties = d
        return list_executions_deleted_at
