...
T = TypeVar("T", bound="ListUsersUsername")


@_attrs_define
class ListUsersUsername:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_username.additional_properties = d
        return list_users_username
