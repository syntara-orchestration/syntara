...
T = TypeVar("T", bound="ListSettingsCreatedAt")


@_attrs_define
class ListSettingsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_settings_created_at.additional_properties = d
        return list_settings_created_at
