...
T = TypeVar("T", bound="ListGroupsDirectoryCreatedAt")


@_attrs_define
class ListGroupsDirectoryCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_directory_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_groups_directory_created_at.additional_properties = d
        return list_groups_directory_created_at
