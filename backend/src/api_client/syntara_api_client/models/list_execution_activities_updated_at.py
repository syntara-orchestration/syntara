...
T = TypeVar("T", bound="ListExecutionActivitiesUpdatedAt")


@_attrs_define
class ListExecutionActivitiesUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_execution_activities_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_execution_activities_updated_at.additional_properties = d
        return list_execution_activities_updated_at
