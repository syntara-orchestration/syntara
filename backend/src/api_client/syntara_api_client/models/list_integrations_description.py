...
T = TypeVar("T", bound="ListIntegrationsDescription")


@_attrs_define
class ListIntegrationsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integrations_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_integrations_description.additional_properties = d
        return list_integrations_description
