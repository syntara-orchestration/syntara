...
T = TypeVar("T", bound="ListWorkflowsUpdatedAt")


@_attrs_define
class ListWorkflowsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_workflows_updated_at.additional_properties = d
        return list_workflows_updated_at
