...
T = TypeVar("T", bound="ListSettingsGroup")


@_attrs_define
class ListSettingsGroup:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_settings_group.additional_properties = d
        return list_settings_group
