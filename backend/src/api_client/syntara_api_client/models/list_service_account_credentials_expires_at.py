...
T = TypeVar("T", bound="ListServiceAccountCredentialsExpiresAt")


@_attrs_define
class ListServiceAccountCredentialsExpiresAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_service_account_credentials_expires_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_service_account_credentials_expires_at.additional_properties = d
        return list_service_account_credentials_expires_at
