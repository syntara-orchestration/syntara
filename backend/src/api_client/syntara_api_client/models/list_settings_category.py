...
T = TypeVar("T", bound="ListSettingsCategory")


@_attrs_define
class ListSettingsCategory:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_settings_category.additional_properties = d
        return list_settings_category
