...
T = TypeVar("T", bound="ListWorkflowsDescription")


@_attrs_define
class ListWorkflowsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_workflows_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_workflows_description.additional_properties = d
