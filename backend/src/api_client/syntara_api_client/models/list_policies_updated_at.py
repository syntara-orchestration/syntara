...
T = TypeVar("T", bound="ListPoliciesUpdatedAt")


@_attrs_define
class ListPoliciesUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_policies_updated_at.additional_properties = d
        return list_policies_updated_at
