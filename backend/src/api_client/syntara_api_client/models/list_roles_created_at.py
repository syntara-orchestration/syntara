...
T = TypeVar("T", bound="ListRolesCreatedAt")


@_attrs_define
class ListRolesCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_roles_created_at.additional_properties = d
        return list_roles_created_at
