...
T = TypeVar("T", bound="ListGroupsDirectoryUpdatedAt")


@_attrs_define
class ListGroupsDirectoryUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_directory_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_groups_directory_updated_at.additional_properties = d
        return list_groups_directory_updated_at
