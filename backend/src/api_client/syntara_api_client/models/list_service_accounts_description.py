...
T = TypeVar("T", bound="ListServiceAccountsDescription")


@_attrs_define
class ListServiceAccountsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_service_accounts_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_service_accounts_description.additional_properties = d
        return list_service_accounts_description
