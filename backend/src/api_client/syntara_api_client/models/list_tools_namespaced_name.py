...
T = TypeVar("T", bound="ListToolsNamespacedName")


@_attrs_define
class ListToolsNamespacedName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_tools_namespaced_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_tools_namespaced_name.additional_properties = d
        return list_tools_namespaced_name
