...
T = TypeVar("T", bound="ListUsersLastName")


@_attrs_define
class ListUsersLastName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_last_name.additional_properties = d
        return list_users_last_name
