...
T = TypeVar("T", bound="ListIdentityProvidersUpdatedAt")


@_attrs_define
class ListIdentityProvidersUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_identity_providers_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_identity_providers_updated_at.additional_properties = d
        return list_identity_providers_updated_at
