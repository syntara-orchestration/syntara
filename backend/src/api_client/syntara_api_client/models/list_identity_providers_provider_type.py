...
T = TypeVar("T", bound="ListIdentityProvidersProviderType")


@_attrs_define
class ListIdentityProvidersProviderType:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_identity_providers_provider_type = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_identity_providers_provider_type.additional_properties = d
        return list_identity_providers_provider_type
