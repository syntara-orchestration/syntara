...
T = TypeVar("T", bound="ListIntegrationToolsNamespacedName")


@_attrs_define
class ListIntegrationToolsNamespacedName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_tools_namespaced_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_integration_tools_namespaced_name.additional_properties = d
        return list_integration_tools_namespaced_name
