...
T = TypeVar("T", bound="ListSettingsUpdatedAt")


@_attrs_define
class ListSettingsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_settings_updated_at.additional_properties = d
        return list_settings_updated_at
