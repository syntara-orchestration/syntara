...
T = TypeVar("T", bound="ListProjectWorkflowsName")


@_attrs_define
class ListProjectWorkflowsName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_workflows_name = cls(
            contains=contains,
        ...
        list_project_workflows_name.additional_properties = d
        return list_project_workflows_name
