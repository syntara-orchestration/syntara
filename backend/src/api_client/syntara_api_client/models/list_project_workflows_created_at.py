...
T = TypeVar("T", bound="ListProjectWorkflowsCreatedAt")


@_attrs_define
class ListProjectWorkflowsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_workflows_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_project_workflows_created_at.additional_properties = d
        return list_project_workflows_created_at
