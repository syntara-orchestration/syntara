...
class OIDCConfigurationResponse:
    ...
    Attributes:
        ...
        enable_rp_initiated_logout (bool | Unset): Enable RP-initiated logout redirect to IdP when user logs out
            Default: False.
        claim_mapping (OIDCClaimMapping | Unset): Maps Automation Orchestrator user fields to IdP-specific OIDC claim
            names.
        group_jmespath_expression (None | str | Unset): JMESPath expression for group extraction
        group_mapping_entries (list[OIDCGroupMappingEntry] | Unset): IdP-to-Automation Orchestrator group mapping
            entries
