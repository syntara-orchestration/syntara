...
T = TypeVar("T", bound="TextAreaField")
...
class TextAreaField:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["textarea"], d.pop("type"))
        if type_ != "textarea":
            raise ValueError(f"type must match const 'textarea', got '{type_}'")
