...
T = TypeVar("T", bound="ListWorkflowVersionsUpdatedAt")


@_attrs_define
class ListWorkflowVersionsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_workflow_versions_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_workflow_versions_updated_at.additional_properties = d
        return list_workflow_versions_updated_at
