...
T = TypeVar("T", bound="ListCredentialsName")


@_attrs_define
class ListCredentialsName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_credentials_name.additional_properties = d
        return list_credentials_name
