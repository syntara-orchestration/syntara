...
T = TypeVar("T", bound="ListToolsDescription")


@_attrs_define
class ListToolsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_tools_description.additional_properties = d
        return list_tools_description
