...
T = TypeVar("T", bound="ListGroupsDirectoryName")


@_attrs_define
class ListGroupsDirectoryName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_directory_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_groups_directory_name.additional_properties = d
        return list_groups_directory_name
