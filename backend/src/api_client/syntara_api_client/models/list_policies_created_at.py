...
T = TypeVar("T", bound="ListPoliciesCreatedAt")


@_attrs_define
class ListPoliciesCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_policies_created_at.additional_properties = d
        return list_policies_created_at
