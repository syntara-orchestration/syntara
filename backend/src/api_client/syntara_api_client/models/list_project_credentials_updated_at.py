...
T = TypeVar("T", bound="ListProjectCredentialsUpdatedAt")


@_attrs_define
class ListProjectCredentialsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_credentials_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_project_credentials_updated_at.additional_properties = d
        return list_project_credentials_updated_at
