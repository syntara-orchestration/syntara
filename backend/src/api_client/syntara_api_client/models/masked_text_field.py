...
T = TypeVar("T", bound="MaskedTextField")
...
class MaskedTextField:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["masked_text"], d.pop("type"))
        if type_ != "masked_text":
            raise ValueError(f"type must match const 'masked_text', got '{type_}'")
