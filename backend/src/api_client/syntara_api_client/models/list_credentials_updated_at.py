...
T = TypeVar("T", bound="ListCredentialsUpdatedAt")


@_attrs_define
class ListCredentialsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_credentials_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_credentials_updated_at.additional_properties = d
        return list_credentials_updated_at
