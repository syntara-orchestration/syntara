...
T = TypeVar("T", bound="ListUsersDirectoryUsername")


@_attrs_define
class ListUsersDirectoryUsername:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_directory_username = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_users_directory_username.additional_properties = d
        return list_users_directory_username
