...
T = TypeVar("T", bound="ListIntegrationToolsDescription")


@_attrs_define
class ListIntegrationToolsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_tools_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_integration_tools_description.additional_properties = d
        return list_integration_tools_description
