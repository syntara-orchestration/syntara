...
T = TypeVar("T", bound="ListIntegrationsName")


@_attrs_define
class ListIntegrationsName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integrations_name.additional_properties = d
        return list_integrations_name
