...
T = TypeVar("T", bound="ListIntegrationModelsCreatedAt")


@_attrs_define
class ListIntegrationModelsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_models_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_integration_models_created_at.additional_properties = d
        return list_integration_models_created_at
