...
T = TypeVar("T", bound="ListUsersDirectoryUpdatedAt")


@_attrs_define
class ListUsersDirectoryUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_directory_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_users_directory_updated_at.additional_properties = d
        return list_users_directory_updated_at
