...
T = TypeVar("T", bound="ListRolesUpdatedAt")


@_attrs_define
class ListRolesUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_roles_updated_at.additional_properties = d
        return list_roles_updated_at
