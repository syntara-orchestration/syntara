...
T = TypeVar("T", bound="ListApprovalsName")


@_attrs_define
class ListApprovalsName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_approvals_name.additional_properties = d
        return list_approvals_name
