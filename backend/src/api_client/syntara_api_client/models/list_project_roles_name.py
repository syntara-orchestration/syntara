...
T = TypeVar("T", bound="ListProjectRolesName")


@_attrs_define
class ListProjectRolesName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_roles_name.additional_properties = d
        return list_project_roles_name
