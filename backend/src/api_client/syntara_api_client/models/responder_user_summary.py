...
T = TypeVar("T", bound="ResponderUserSummary")


@_attrs_define
class ResponderUserSummary:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        responder_user_summary = cls(
            id=id,
            username=username,
        )

        responder_user_summary.additional_properties = d
        return responder_user_summary
