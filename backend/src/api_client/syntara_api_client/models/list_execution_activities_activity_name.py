...
T = TypeVar("T", bound="ListExecutionActivitiesActivityName")


@_attrs_define
class ListExecutionActivitiesActivityName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_execution_activities_activity_name = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_execution_activities_activity_name.additional_properties = d
        return list_execution_activities_activity_name
