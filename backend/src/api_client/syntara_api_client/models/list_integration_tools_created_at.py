...
T = TypeVar("T", bound="ListIntegrationToolsCreatedAt")


@_attrs_define
class ListIntegrationToolsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_tools_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_integration_tools_created_at.additional_properties = d
        return list_integration_tools_created_at
