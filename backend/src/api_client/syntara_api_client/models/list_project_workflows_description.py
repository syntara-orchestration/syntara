...
T = TypeVar("T", bound="ListProjectWorkflowsDescription")


@_attrs_define
class ListProjectWorkflowsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_workflows_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_project_workflows_description.additional_properties = d
        return list_project_workflows_description
