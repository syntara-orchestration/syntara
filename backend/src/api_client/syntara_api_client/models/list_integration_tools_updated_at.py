...
T = TypeVar("T", bound="ListIntegrationToolsUpdatedAt")


@_attrs_define
class ListIntegrationToolsUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_tools_updated_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_integration_tools_updated_at.additional_properties = d
        return list_integration_tools_updated_at
