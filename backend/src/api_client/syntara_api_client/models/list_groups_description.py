...
T = TypeVar("T", bound="ListGroupsDescription")


@_attrs_define
class ListGroupsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_description.additional_properties = d
        return list_groups_description
