...
T = TypeVar("T", bound="ListApprovalsCreatedAt")


@_attrs_define
class ListApprovalsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_approvals_created_at.additional_properties = d
        return list_approvals_created_at
