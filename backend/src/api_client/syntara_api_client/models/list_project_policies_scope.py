...
T = TypeVar("T", bound="ListProjectPoliciesScope")


@_attrs_define
class ListProjectPoliciesScope:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_policies_scope = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_project_policies_scope.additional_properties = d
        return list_project_policies_scope
