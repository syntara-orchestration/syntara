...
T = TypeVar("T", bound="ListRolesDescription")


@_attrs_define
class ListRolesDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_roles_description.additional_properties = d
        return list_roles_description
