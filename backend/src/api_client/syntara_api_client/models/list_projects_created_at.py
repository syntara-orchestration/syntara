...
T = TypeVar("T", bound="ListProjectsCreatedAt")


@_attrs_define
class ListProjectsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_projects_created_at.additional_properties = d
        return list_projects_created_at
