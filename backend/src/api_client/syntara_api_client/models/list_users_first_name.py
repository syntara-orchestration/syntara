...
T = TypeVar("T", bound="ListUsersFirstName")


@_attrs_define
class ListUsersFirstName:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_first_name.additional_properties = d
        return list_users_first_name
