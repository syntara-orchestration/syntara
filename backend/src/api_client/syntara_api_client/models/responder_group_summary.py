...
T = TypeVar("T", bound="ResponderGroupSummary")


@_attrs_define
class ResponderGroupSummary:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        responder_group_summary = cls(
            id=id,
            name=name,
        )

        responder_group_summary.additional_properties = d
        return responder_group_summary
