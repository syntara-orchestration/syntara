...
T = TypeVar("T", bound="ListGroupsCreatedAt")


@_attrs_define
class ListGroupsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_created_at.additional_properties = d
        return list_groups_created_at
