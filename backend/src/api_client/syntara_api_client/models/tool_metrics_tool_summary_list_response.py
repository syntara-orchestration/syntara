...
if TYPE_CHECKING:
    from ..models.tool_metrics_tool_summary import ToolMetricsToolSummary


T = TypeVar("T", bound="ToolMetricsToolSummaryListResponse")


@_attrs_define
class ToolMetricsToolSummaryListResponse:
    """Paginated list response for tool metrics summaries.

    Attributes:
        resources (list[ToolMetricsToolSummary]): Array of resources in current page
    ...
    resources: list[ToolMetricsToolSummary]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ToolMetricsToolSummary.from_dict(resources_item_data)
        ...
        tool_metrics_tool_summary_list_response = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        tool_metrics_tool_summary_list_response.additional_properties = d
        return tool_metrics_tool_summary_list_response
