...
T = TypeVar("T", bound="ListPoliciesDescription")


@_attrs_define
class ListPoliciesDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_policies_description.additional_properties = d
        return list_policies_description
