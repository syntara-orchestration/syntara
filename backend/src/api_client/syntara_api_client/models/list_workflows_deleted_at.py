...
T = TypeVar("T", bound="ListWorkflowsDeletedAt")


@_attrs_define
class ListWorkflowsDeletedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_workflows_deleted_at.additional_properties = d
        return list_workflows_deleted_at
