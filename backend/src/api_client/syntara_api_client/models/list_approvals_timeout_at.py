...
T = TypeVar("T", bound="ListApprovalsTimeoutAt")


@_attrs_define
class ListApprovalsTimeoutAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_approvals_timeout_at.additional_properties = d
        return list_approvals_timeout_at
