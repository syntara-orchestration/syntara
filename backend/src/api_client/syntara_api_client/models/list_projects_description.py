...
T = TypeVar("T", bound="ListProjectsDescription")


@_attrs_define
class ListProjectsDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_projects_description.additional_properties = d
        return list_projects_description
