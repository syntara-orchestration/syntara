...
T = TypeVar("T", bound="ListIntegrationToolsName")


@_attrs_define
class ListIntegrationToolsName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_tools_name = cls(
            contains=contains,
        ...
        list_integration_tools_name.additional_properties = d
        return list_integration_tools_name
