...
T = TypeVar("T", bound="ListPoliciesScope")


@_attrs_define
class ListPoliciesScope:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_policies_scope.additional_properties = d
        return list_policies_scope
