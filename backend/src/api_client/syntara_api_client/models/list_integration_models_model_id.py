...
T = TypeVar("T", bound="ListIntegrationModelsModelId")


@_attrs_define
class ListIntegrationModelsModelId:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integration_models_model_id = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_integration_models_model_id.additional_properties = d
        return list_integration_models_model_id
