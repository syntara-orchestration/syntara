...
T = TypeVar("T", bound="ListIntegrationsCreatedAt")


@_attrs_define
class ListIntegrationsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_integrations_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_integrations_created_at.additional_properties = d
        return list_integrations_created_at
