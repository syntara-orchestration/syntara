...
T = TypeVar("T", bound="ListCredentialsCreatedAt")


@_attrs_define
class ListCredentialsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_credentials_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            in_=in_,
        ...
        list_credentials_created_at.additional_properties = d
        return list_credentials_created_at
