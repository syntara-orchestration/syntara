...
T = TypeVar("T", bound="ListExecutionsCreatedAt")


@_attrs_define
class ListExecutionsCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_executions_created_at = cls(
            eq=eq,
            gt=gt,
            gte=gte,
            lt=lt,
        ...
        list_executions_created_at.additional_properties = d
        return list_executions_created_at
