...
T = TypeVar("T", bound="ListGroupsDirectoryDescription")


@_attrs_define
class ListGroupsDirectoryDescription:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_directory_description = cls(
            contains=contains,
            eq=eq,
            gt=gt,
            gte=gte,
        ...
        list_groups_directory_description.additional_properties = d
        return list_groups_directory_description
