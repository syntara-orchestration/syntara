...
T = TypeVar("T", bound="ListUsersCreatedAt")


@_attrs_define
class ListUsersCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_created_at.additional_properties = d
        return list_users_created_at
