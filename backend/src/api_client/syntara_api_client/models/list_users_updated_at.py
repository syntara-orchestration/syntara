...
T = TypeVar("T", bound="ListUsersUpdatedAt")


@_attrs_define
class ListUsersUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_users_updated_at.additional_properties = d
        return list_users_updated_at
