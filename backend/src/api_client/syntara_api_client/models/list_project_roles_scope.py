...
T = TypeVar("T", bound="ListProjectRolesScope")


@_attrs_define
class ListProjectRolesScope:
    """
    Attributes:
        contains (str | Unset):
        eq (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_project_roles_scope.additional_properties = d
        return list_project_roles_scope
