...
from ...models.list_project_roles_created_at import ListProjectRolesCreatedAt
from ...models.list_project_roles_description import ListProjectRolesDescription
from ...models.list_project_roles_id import ListProjectRolesId
from ...models.list_project_roles_is_builtin import ListProjectRolesIsBuiltin
from ...models.list_project_roles_name import ListProjectRolesName
from ...models.list_project_roles_scope import ListProjectRolesScope
from ...models.list_project_roles_updated_at import ListProjectRolesUpdatedAt
...
def _get_kwargs(
    ...
    *,
    ...
    id: ListProjectRolesId | Unset = UNSET,
    created_at: ListProjectRolesCreatedAt | Unset = UNSET,
    updated_at: ListProjectRolesUpdatedAt | Unset = UNSET,
    name: ListProjectRolesName | Unset = UNSET,
    description: ListProjectRolesDescription | Unset = UNSET,
    is_builtin: ListProjectRolesIsBuiltin | Unset = UNSET,
    scope: ListProjectRolesScope | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        id (ListProjectRolesId | Unset):
        created_at (ListProjectRolesCreatedAt | Unset):
        updated_at (ListProjectRolesUpdatedAt | Unset):
        name (ListProjectRolesName | Unset):
        description (ListProjectRolesDescription | Unset):
        is_builtin (ListProjectRolesIsBuiltin | Unset):
        scope (ListProjectRolesScope | Unset):
