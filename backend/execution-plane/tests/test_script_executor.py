"""Unit tests for execution_plane.script_executor (pure EP, no Temporal dependency)."""
...
class TestScriptActivityTimeoutAndInputs:
    """Cover remaining uncovered paths in execute_script."""
    ...
    async def test_timeout_raises_timeout_error(self) -> None:
        ...
        with (
            ...
            await execute_script({"language": "bash", "code": "sleep 999", "_engine_timeout_seconds": 10}, None)
...
class TestOutputLimitIntegration:
    """Test that output limiting works end-to-end via execute_script."""
...
class TestMemoryLimitIntegration:
    """Test cgroup memory limit injection in execute_script."""
