...
def _make_metadata(
    *,
    ...
    return FileMetadata(
        ...
        size_bytes=100,
        file_path="syntara-abc-test.pdf",
        status=file_status,
...
class TestFileDetailEndpoint:
    ...
    async def test_get_file_details_success(self) -> None:
        ...
        metadata = FileMetadata(
            ...
            mime_type="application/pdf",
            size_bytes=524288,
            file_path="/storage/syntara-abc-report.pdf",
    ...
    async def test_get_file_details_includes_conversion_error(self) -> None:
        ...
        metadata = FileMetadata(
            ...
            size_bytes=1024,
            file_path="/storage/syntara-abc-bad.docx",
    ...
    async def test_get_file_details_pending_conversion(self) -> None:
        ...
        metadata = FileMetadata(
            ...
            mime_type="application/pdf",
            size_bytes=2048,
            file_path="/storage/syntara-abc-uploading.pdf",
