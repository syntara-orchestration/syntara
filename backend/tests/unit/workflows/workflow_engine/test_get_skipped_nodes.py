"""Unit tests for SyntaraWorkflow.get_skipped_nodes query method.

Verifies that only one get_skipped_nodes method exists on SyntaraWorkflow,
...
class TestGetSkippedNodesUniqueness:
    ...
    def test_only_one_get_skipped_nodes_method_defined_in_source(self) -> None:
        ...
        source = inspect.getsource(SyntaraWorkflow)
    ...
    def test_get_skipped_nodes_is_callable(self) -> None:
        ...
        assert hasattr(SyntaraWorkflow, "get_skipped_nodes")
        assert callable(SyntaraWorkflow.get_skipped_nodes)
...
class TestGetSkippedNodesNoHasattrGuard:
    ...
    def test_no_hasattr_guard_in_get_skipped_nodes_source(self) -> None:
        ...
        source = inspect.getsource(SyntaraWorkflow.get_skipped_nodes)
...
class TestGetSkippedNodesReturnValue:
    ...
    def _make_workflow_with_skipped_nodes(self, skipped: set[str]) -> SyntaraWorkflow:
        """Create a SyntaraWorkflow instance with skipped_nodes set directly."""
        wf = SyntaraWorkflow.__new__(SyntaraWorkflow)
