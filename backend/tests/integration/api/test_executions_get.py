...
@pytest.mark.asyncio
async def test_list_executions_workflow_name_after_hard_delete(
    auth_client: AsyncClient,
    test_workflow: Workflow,
    test_user: User,
    ...
    """Test that executions are still listed after their workflow is hard-deleted."""
    ...
    assert data["resources"][0]["workflow_id"] is None
